...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxGKA-mCpn_8C3iteBG0ykHNZpoSpa2lBah5QI1IE7iw_SmNlUoq6h-NzB4nxbMlthKKA/exec';
...
async function showResults() {
  ...
  const saved = await saveResultToSheets([
    ...
    student.comentario,  // columna F — carrera solicitada
    correct, wrong, total,
    pct + '%',
